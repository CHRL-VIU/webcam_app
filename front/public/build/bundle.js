...
var app = (function () {
    ...
    /* Applications/XAMPP/xamppfiles/htdocs/node_modules/svelte-waypoint/src/Waypoint.svelte generated by Svelte v3.24.0 */
    const file = "Applications/XAMPP/xamppfiles/htdocs/node_modules/svelte-waypoint/src/Waypoint.svelte";
    ...
    /* Applications/XAMPP/xamppfiles/htdocs/node_modules/svelte-image/src/Image.svelte generated by Svelte v3.24.0 */
    const file$1 = "Applications/XAMPP/xamppfiles/htdocs/node_modules/svelte-image/src/Image.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*image*/ 1) image_1_changes.src = "" + (imgPath + /*image*/ ctx[0]);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ images, Image, image, imgPath });
    ...
    class Image_1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { image: 0 });
    ...
    const file$3 = "src/Images.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	image = new Image_1({
    			props: {
    				image: /*$images*/ ctx[2][/*$slide_id*/ ctx[3]]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			h3 = element("h3");
    			t1 = text("Image Number: ");
    			t2 = text(/*$slide_id*/ ctx[3]);
    			t3 = space();
    			input = element("input");
    			add_location(h3, file$3, 21, 0, 522);
    			attr_dev(input, "type", "range");
    			attr_dev(input, "min", "0");
    			attr_dev(input, "max", /*$numImages*/ ctx[1]);
    			attr_dev(input, "step", "1");
    			add_location(input, file$3, 22, 0, 557);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*$slide_id*/ ctx[3]);
    			current = true;
    		...
    		p: function update(ctx, [dirty]) {
    			const image_changes = {};
    			if (dirty & /*$images, $slide_id*/ 12) image_changes.image = /*$images*/ ctx[2][/*$slide_id*/ ctx[3]];
    			image.$set(image_changes);
    			if (!current || dirty & /*$slide_id*/ 8) set_data_dev(t2, /*$slide_id*/ ctx[3]);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let $slide_id,
    		$$unsubscribe_slide_id = noop,
    		$$subscribe_slide_id = () => ($$unsubscribe_slide_id(), $$unsubscribe_slide_id = subscribe(slide_id, $$value => $$invalidate(3, $slide_id = $$value)), slide_id);
    	...
    	validate_store(img, "img");
    	component_subscribe($$self, img, $$value => $$invalidate(5, $img = $$value));
    	$$self.$$.on_destroy.push(() => $$unsubscribe_slide_id());
    	const slide_id = writable([$numImages]);
    	...
    	onMount(async () => {
    		...
    		set_store_value(numImages, $numImages = res.length);
    		set_store_value(img, $img = $images[{}]);
    	});
    	...
    	return [slide_id, $numImages, $images, $slide_id, input_change_input_handler];
    }

    class Images extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { slide_id: 0 });
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "mainimage svelte-1geh8ov");
