    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-ettlyx");
    			add_location(img, file, 7, 2, 155);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t14 = text("Note: You can use the blue circle to quickly scrub through the images or use keyboard arrows to go one at a time. ");
    			...
    			add_location(img, file$1, 46, 8, 1519);
    			attr_dev(a, "href", "http://www.viu-hydromet-wx.ca/");
    			attr_dev(a, "class", "logo svelte-1iegzno");
    			add_location(a, file$1, 45, 4, 1455);
    			add_location(button0, file$1, 49, 8, 1662);
    			add_location(button1, file$1, 52, 12, 1744);
    			add_location(button2, file$1, 55, 12, 1830);
    			add_location(button3, file$1, 58, 12, 1915);
    			attr_dev(div0, "class", "header-right svelte-1iegzno");
    			add_location(div0, file$1, 48, 4, 1626);
    			attr_dev(div1, "class", "header svelte-1iegzno");
    			add_location(div1, file$1, 44, 0, 1429);
    			add_location(h5, file$1, 69, 2, 2128);
    			attr_dev(div2, "class", "filename svelte-1iegzno");
    			add_location(div2, file$1, 68, 0, 2100);
    			attr_dev(input, "type", "range");
    			attr_dev(input, "min", "0");
    			attr_dev(input, "max", /*$numImages*/ ctx[1]);
    			attr_dev(input, "step", "1");
    			attr_dev(input, "class", "slider svelte-1iegzno");
    			add_location(input, file$1, 73, 2, 2249);
    			attr_dev(div3, "class", "rangecontainer svelte-1iegzno");
    			add_location(div3, file$1, 72, 1, 2216);
    			add_location(small0, file$1, 75, 144, 2498);
    			attr_dev(small1, "class", "figcaption svelte-1iegzno");
    			add_location(small1, file$1, 75, 1, 2355);
    			attr_dev(figure, "class", "slideshow");
    			add_location(figure, file$1, 67, 0, 2070);
    			attr_dev(div4, "class", "body");
    			set_style(div4, "text-align", "center");
    			add_location(div4, file$1, 66, 0, 2019);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
