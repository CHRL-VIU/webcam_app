    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 52, 8, 1680);
    			attr_dev(a, "href", "http://www.viu-hydromet-wx.ca/");
    			attr_dev(a, "class", "logo svelte-1iegzno");
    			add_location(a, file$1, 51, 4, 1616);
    			add_location(button0, file$1, 55, 8, 1823);
    			add_location(button1, file$1, 58, 12, 1905);
    			add_location(button2, file$1, 61, 12, 1991);
    			add_location(button3, file$1, 64, 12, 2076);
    			attr_dev(div0, "class", "header-right svelte-1iegzno");
    			add_location(div0, file$1, 54, 4, 1787);
    			attr_dev(div1, "class", "header svelte-1iegzno");
    			add_location(div1, file$1, 50, 0, 1590);
    			add_location(h5, file$1, 75, 2, 2364);
    			attr_dev(div2, "class", "filename svelte-1iegzno");
    			add_location(div2, file$1, 74, 0, 2336);
    			attr_dev(input, "type", "range");
    			attr_dev(input, "min", "0");
    			attr_dev(input, "max", /*$numImages*/ ctx[1]);
    			attr_dev(input, "step", "1");
    			attr_dev(input, "class", "slider svelte-1iegzno");
    			add_location(input, file$1, 79, 2, 2485);
    			attr_dev(div3, "class", "rangecontainer svelte-1iegzno");
    			add_location(div3, file$1, 78, 1, 2452);
    			add_location(small0, file$1, 81, 144, 2734);
    			attr_dev(small1, "class", "figcaption svelte-1iegzno");
    			add_location(small1, file$1, 81, 1, 2591);
    			attr_dev(figure, "class", "slideshow");
    			add_location(figure, file$1, 73, 0, 2306);
    			attr_dev(div4, "class", "body");
    			set_style(div4, "text-align", "center");
    			add_location(div4, file$1, 72, 0, 2255);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
