    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t11 = space();
    			input = element("input");
    			add_location(button0, file$1, 47, 0, 1515);
    			add_location(button1, file$1, 50, 0, 1561);
    			add_location(button2, file$1, 53, 0, 1611);
    			add_location(button3, file$1, 56, 0, 1660);
    			attr_dev(div0, "class", "slideshow");
    			add_location(div0, file$1, 60, 0, 1734);
    			add_location(h3, file$1, 65, 0, 1840);
    			attr_dev(input, "type", "range");
    			attr_dev(input, "min", "0");
    			attr_dev(input, "max", /*$numImages*/ ctx[1]);
    			attr_dev(input, "step", "1");
    			attr_dev(input, "class", "slider svelte-12nn2w8");
    			add_location(input, file$1, 66, 0, 1883);
    			attr_dev(div1, "class", "rangecontainer svelte-12nn2w8");
    			add_location(div1, file$1, 64, 0, 1809);
    			attr_dev(div2, "class", "body");
    			add_location(div2, file$1, 59, 0, 1712);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
