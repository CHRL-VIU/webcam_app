    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "header-right svelte-1353vzk");
    			...
    			add_location(h5, file$1, 72, 0, 2084);
    			attr_dev(div2, "class", "slideshow");
    			add_location(div2, file$1, 71, 0, 2058);
    			attr_dev(input, "type", "range");
    			attr_dev(input, "min", "0");
    			attr_dev(input, "max", /*$numImages*/ ctx[1]);
    			attr_dev(input, "step", "1");
    			attr_dev(input, "class", "slider svelte-1353vzk");
    			add_location(input, file$1, 76, 0, 2269);
    			attr_dev(div3, "class", "rangecontainer svelte-1353vzk");
    			add_location(div3, file$1, 75, 0, 2239);
    			attr_dev(div4, "class", "body");
    			add_location(div4, file$1, 70, 0, 2037);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(h5, t10);
    			append_dev(div2, t11);
    			mount_component(image, div2, null);
    			append_dev(div4, t12);
